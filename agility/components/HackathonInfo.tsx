...
export function HackathonInfo({ attendees }: { attendees: number }) {
  ...
  return (
    <div className="w-full max-w-xl mx-auto bg-white rounded-3xl p-8 border shadow-sm">
      ...
      {/* Main Content */}
      <h2 className="text-4xl font-bold text-center mb-8">World's Shortest Hackathon</h2>
      ...
      <div className="pt-4 border-t text-center">
        <p className="text-sm text-gray-500">Breaking records for the fastest innovation event</p>
      </div>
    </div>
  )
}
